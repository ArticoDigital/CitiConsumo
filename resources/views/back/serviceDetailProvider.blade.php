        ...
        @endforeach
            ...
            <div class="col-12 row">
                <ul class="col-6 small-12">
                    ...
                    <li class="col-12"><b>Tipo de servicios:</b>{{$service->serviceType->kindServices->name}} - {{$service->serviceType->name}}</li>
            ...
            <div class="col-12 row">
                <ul class="col-6 small-12">
                    ...
                    <li class="col-12"><b>Nombre: </b>{{$service->provider->user->name}} {{$service->provider->user->last_name}} </li>
                    <li class="col-12"><b>Ubicación: </b>{{$service->provider->user->location}}</li>
                    <li class="col-12"><b>Dirección: </b>{{$service->provider->user->address}}</li>
                    <li class="col-12"><b>Tel: </b>{{$service->provider->user->phone}}</li>
                    <li class="col-12"><b>Celular: </b>{{$service->provider->user->cellphone}}
                    </li>
                    <li class="col-12"><b>Correo: </b>{{$service->provider->user->email}}</li>

                    
                </ul>
                <figure class="col-3" style="margin: 0">
                    @if($service->provider->user->profile_image)
                            <img src="{{asset('uploads/profiles/'. $service->provider->user->profile_image)}}" class="col-12"
                                 alt="">
                        @else
