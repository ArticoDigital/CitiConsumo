        ...
        <label for="place" class="col-4 medium-4 small-12 Form-Control">
            <span id="PlaceIcon" class="icon" style="cursor:pointer">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                     width="25px" height="25px" viewBox="0 0 485.211 485.21">
                    <g fill="#AAA">
            ...
            <input id="autocomplete" name="place" type="text" placeholder="¿Dónde estoy?" value="{{old('place')}}">
