...
@section('Header')
    ...
    <form class="Form withAddress row center col-9" method="GET" action="{{route('platform', 'mascotas')}}">
        <label for="place" class="col-3 middle-3 small-6 Form-Control">
        ...
        <label for="date" class="col-3 middle-3 small-6 Form-Control">
        ...
        <label for="size" class="col-3 middle-3 small-6 Form-Control">
        ...
        <label for="breed" class="col-3 middle-3 small-6 Form-Control">
