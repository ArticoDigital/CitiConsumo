...
@section('content')
        ...
        <form style="min-width: 360px; max-width: 500px; margin: 0px auto; padding: 10px 30px; background-color: white; border-radius: 10px;" class="row Form-register" role="form" method="POST" action="{{route('postEmail')}}">
        <h3 class="col-12 bottom-element">
